...
namespace nav2_map_server
{
    ...
    nav2_util::CallbackReturn CostmapFilterInfoServer::on_configure(const rclcpp_lifecycle::State& /*state*/)
    {
    ...
    nav2_util::CallbackReturn CostmapFilterInfoServer::on_activate(const rclcpp_lifecycle::State& /*state*/)
    {
    ...
    nav2_util::CallbackReturn CostmapFilterInfoServer::on_deactivate(const rclcpp_lifecycle::State& /*state*/)
    {
    ...
    nav2_util::CallbackReturn CostmapFilterInfoServer::on_cleanup(const rclcpp_lifecycle::State& /*state*/)
    {
    ...
    nav2_util::CallbackReturn CostmapFilterInfoServer::on_shutdown(const rclcpp_lifecycle::State& /*state*/)
    {
